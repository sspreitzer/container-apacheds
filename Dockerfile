...
VOLUME /opt/apacheds/instances/default/log /opt/apacheds/instances/default/run /opt/apacheds/instances/default/cache /opt/apacheds/instances/default/partitions
